...
public class AnnouncementController {
    ...
    public ResponseEntity<?> createAnnouncement(
            ...
            @RequestParam("officialId") @NotNull Long officialId,
    ...
    public ResponseEntity<?> updateAnnouncement(
        ...
        try {
            ...
            return ResponseEntity
                    ...
                    .body(new MessageResponse("Announcement not found: " + e.getMessage()));
        } catch (Exception e) {
            return ResponseEntity
                    .status(HttpStatus.INTERNAL_SERVER_ERROR).body(new MessageResponse("Failed to update announcement: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> deleteAnnouncement(
        ...
        try {
            ...
            return ResponseEntity
                    .status(HttpStatus.INTERNAL_SERVER_ERROR).body(new MessageResponse("Failed to delete announcement: " + e.getMessage()));
        }
    }
}
