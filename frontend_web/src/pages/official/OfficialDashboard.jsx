          ...
          <div className="max-w-full mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Latest Forum Posts */}
                ...
                <h2 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                  ...
                  <div className="mt-4">
                 <Link to="/forum" className="text-sm font-medium text-[#861A2D] hover:text-[#9b3747] transition-colors duration-200">
                   View All Posts &rarr;
                 </Link>
                  </div>
              </div>
              ...
              {/* Latest Service Requests */}
                <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-[#861A2D] flex flex-col h-full">
                 <h2 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                  ...
                  <div className="mt-4">
                 <Link to="/requests" className="text-sm font-medium text-[#861A2D] hover:text-[#9b3747] transition-colors duration-200">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-[#861A2D] flex flex-col h-full">
                  ...
                  <div className="mt-4">
                   <Link to="/appeals-management" className="text-sm font-medium text-[#861A2D] hover:text-[#9b3747] transition-colors duration-200">
                      Manage Appeals &rarr;
                   </Link>
               </div>
             </div>
