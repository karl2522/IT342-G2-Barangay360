...
const ResidentProfile = () => {
  ...
  const daysSinceJoining = calculateDaysSinceJoining();
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300">
              <div className="bg-gradient-to-r from-[#861A2D] via-[#9b2a40] to-[#b43e53] h-40 relative">
                <div className="absolute inset-0 opacity-10 bg-[url('/images/pattern-dots.svg')]"></div>
                {!isEditing && (
              ...
              <div className="px-6 py-4 flex flex-col md:flex-row gap-6 relative">
                ...
                <div className="md:ml-44 mt-20 md:mt-0">
                  ...
                  <div className="flex flex-wrap gap-2 items-center">
                    <span className="bg-[#861A2D]/10 text-[#861A2D] px-3 py-1 rounded-full text-sm font-medium">Resident</span>
                    {daysSinceJoining && daysSinceJoining < 30 && (
                      <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">New Member</span>
                    )}
                  </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300">
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                <button 
                  className="flex items-center justify-center px-4 py-3 bg-[#861A2D]/5 text-[#861A2D] rounded-lg border border-[#861A2D]/10 transition-all duration-200 shadow-sm"
                ...
                <button 
                  className="flex items-center justify-center px-4 py-3 bg-blue-50 text-blue-700 rounded-lg border border-blue-100 transition-all duration-200 shadow-sm"
                ...
                <button 
                  className="flex items-center justify-center px-4 py-3 bg-gray-50 text-gray-700 rounded-lg border border-gray-200 transition-all duration-200 shadow-sm"
